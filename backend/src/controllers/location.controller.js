...
const getStatesDistricts = (req, res) => {
  try {
    res.status(200).json(indiaData); // JSON response
  } catch (error) {
    console.error("Location Error:", error);
    res.status(500).json({ message: "Data fetch fail ho gaya" });
  }
};

// 🚨 Isko export karna mat bhoolna
module.exports = {
  getStatesDistricts,indiaData
};
