    ...
    <div className="product-detail-page">
      <div className="main-container">
        <div className="details-container">
          ...
          <div className="gallery-section">
            ...
            {/* Variant Navigation Helper (For different colors/patterns if linked) */}
          ...
          {/* RIGHT: PRODUCT INFO, PRICE, BADGES & BUTTONS (Clean & Un-messy) */}
      ...
      <div className="full-width-review-section">
        <div className="review-inner-container">
          ...
          {/* Show All Reviews Section Header */}
          ...
          {/* Recommended Products Slider Component */}
