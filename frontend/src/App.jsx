...
useEffect(() => {
  ...
  const fetchCurrencyData = async () => {
    try {
      // 2. Yahan se signal: controller.signal hata diya
...
const fetchSarees = async () => {
  ...
  return (
// 1. File ke sabse upar ye import zaroor daalna:
// import AdminSwitcher from './components/AdminSwitcher'; // Path apne folder ke hisaab se check kar lena
